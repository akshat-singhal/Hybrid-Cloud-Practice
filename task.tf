...
resource "aws_volume_attachment" "ebs_att" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "sudo git clone https://github.com/akshat-singhal/Terraform-Practice1.git /var/www/html/"
    ]
  }
...
resource "aws_cloudfront_distribution" "s3_distribution" {
  origin {
    domain_name = aws_s3_bucket.practicebucket1.bucket_regional_domain_name
